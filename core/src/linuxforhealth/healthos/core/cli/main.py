...
def create_arg_parser():
    ...
    # core
    core = sub_parsers.add_parser("core", help="starts the LFH HealthOS Core Service using the core configuration file.")
    core.add_argument("-f", help="The path to the core configuration file.")
    core.set_defaults(func=_start_core_services)

    # admin
    admin = sub_parsers.add_parser("admin", help="provides access to running tasks and services.")
